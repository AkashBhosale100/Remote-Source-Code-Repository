...
namespace MsgPassingCommunication
{
  Context::Context()
  {
    saveFilePath = "";  // default staging area for incoming files
    sendFilePath = "";  // default staging area for outgoing files
  }
  Context ctx;
...
bool Sender::sendFile(Message msg)
{
  ...
  std::cout << "\nmsg value is:" << msg.value("sendingFile");
  std::cout << "\nHere fileSpec:" << fileSpec;
